...
const Login = ({ setUser }) => {
    ...
    const handleSubmit = e => {
        ...
        // We can use useNavigate for react-router to redirect oru users to a different component/page
        // DO NOT FORGET the forward / in navgiate()
        navigate('/pokedex')
    }
    ...
    return (
        <form className='mx-auto border p-2 m-2' id='login-form' onSubmit={handleSubmit}>
            <div className="mb-3">
                ...
                />
                <div id="userHelp" className="form-text">We'll never share your usename with anyone else.</div>
            </div>
            <div className="mb-3">
